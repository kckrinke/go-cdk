		...
		Convey("Making things...", func() {
			Convey("wrapping on...", func() {
				Convey("word", func() {
					...
					So(wl, ShouldNotBeNil)
					lines := wl.Make(WRAP_WORD, JUSTIFY_LEFT, 10, DefaultMonoStyle)
				...
				Convey("char", func() {
					wl := NewWordLine("one two three", DefaultMonoStyle)
					So(wl, ShouldNotBeNil)
					lines := wl.Make(WRAP_CHAR, JUSTIFY_LEFT, 10, DefaultMonoStyle)
					So(lines, ShouldHaveLength, 2)
				...
				Convey("word-char", func() {
					wl := NewWordLine("one two three", DefaultMonoStyle)
					So(wl, ShouldNotBeNil)
					lines := wl.Make(WRAP_WORD_CHAR, JUSTIFY_LEFT, 10, DefaultMonoStyle)
					So(lines, ShouldHaveLength, 2)
					So(lines[0].Value(), ShouldEqual, "one two ")
				...
				Convey("none", func() {
					wl := NewWordLine("one two three", DefaultMonoStyle)
					So(wl, ShouldNotBeNil)
					lines := wl.Make(WRAP_NONE, JUSTIFY_LEFT, 10, DefaultMonoStyle)
					So(lines, ShouldHaveLength, 1)
					So(lines[0].Value(), ShouldEqual, "one two th")
					So(lines[0].CharacterCount(), ShouldEqual, 10)
					So(lines[0].Len(), ShouldEqual, 5)
			...
			Convey("aligning to...", func() {
				...
				So(lines[0].Len(), ShouldEqual, 1)
				lines = wl.Make(WRAP_NONE, JUSTIFY_RIGHT, 10, DefaultMonoStyle)
				So(lines, ShouldHaveLength, 1)
				So(lines[0].Value(), ShouldEqual, "       one")
				So(lines[0].CharacterCount(), ShouldEqual, 10)
				So(lines[0].Len(), ShouldEqual, 8)
				lines = wl.Make(WRAP_NONE, JUSTIFY_CENTER, 10, DefaultMonoStyle)
				So(lines, ShouldHaveLength, 1)
				So(lines[0].Value(), ShouldEqual, "    one")
				...
				So(wl, ShouldNotBeNil)
				lines = wl.Make(WRAP_NONE, JUSTIFY_FILL, 10, DefaultMonoStyle)
				So(lines, ShouldHaveLength, 1)
				So(lines[0].Value(), ShouldEqual, "one    two")
				So(lines[0].CharacterCount(), ShouldEqual, 10)
